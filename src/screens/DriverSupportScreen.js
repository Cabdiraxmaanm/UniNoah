  ...
  const handleContactSupport = () => {
    Alert.alert(
      ...
      [
        { 
          text: '📧 Email', 
          onPress: () => Linking.openURL('mailto:uninoaha@gmail.com?subject=Driver Support Request&body=Hello UniNoah Driver Support Team,\n\nI need help with:\n\n') 
        },
        { 
          text: '📱 Phone', 
        ...
        { 
          text: '💬 WhatsApp', 
          onPress: () => Linking.openURL('https://wa.me/252634065954?text=Hello, I need help with UniNoah driver app') 
        },
  ...
  const handleReportIssue = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Navigation Problems', onPress: () => reportIssue('Navigation Problems') },
        { text: 'Payment Issues', onPress: () => reportIssue('Payment Issues') },
        { text: 'Student Issues', onPress: () => reportIssue('Student Issues') },
  ...
  const faqData = [
    {
      ...
      answer: "1. Go to 'Requests' tab or check the map\n2. Review incoming ride requests\n3. Check pickup location and destination\n4. Tap 'Accept Request' to confirm\n5. Navigate to pickup location"
    },
    {
      question: "What if a student cancels the ride?",
      answer: "If a student cancels:\n• You'll receive an immediate notification\n• The ride will be removed from your active rides\n• You can accept new requests immediately\n• No penalty for student cancellations"
    },
    {
      question: "How do I navigate to pickup locations?",
      answer: "After accepting a request:\n• Tap 'Start Navigation' in the ride card\n• Use the built-in navigation system\n• Follow turn-by-turn directions\n• Contact student if you need clarification"
    },
    {
      question: "How do I complete a ride?",
      answer: "To complete a ride:\n• Navigate to the destination\n• Confirm student has exited the vehicle\n• Tap 'Complete Ride' in the active ride card\n• Rate the student experience\n• Payment will be processed automatically"
    },
    {
      question: "How do I manage my availability?",
      answer: "Set your availability:\n• Go to 'Availability' tab\n• Set your working hours and days\n• Toggle online/offline status\n• Update your location for better matching"
    }
  ];
    ...
    <View style={styles.container}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            >
              ...
              <Text style={styles.supportHeroSubtitle}>Get assistance with rides, navigation, and more</Text>
            </Animated.View>
          </View>
        </LinearGradient>
      </Animated.View>
      ...
      >
            ...
            <View style={styles.appInfoContent}>
              <View style={styles.appInfoHeader}>
                ...
                <View style={styles.appDetails}>
                  <Text style={styles.appName}>UniNoah Driver</Text>
                  <Text style={styles.appVersion}>Version 1.0.0</Text>
                  <Text style={styles.appDescription}>Driver App for University Rides</Text>
                </View>
              </View>
        ...
        <View style={styles.section}>
          ...
          {renderSupportOption('document-text', 'Driver Guide', 'Learn how to use UniNoah effectively', () => Alert.alert('Driver Guide', 'Driver guide coming soon!'), Colors.accent)}
          {renderSupportOption('people', 'Community', 'Join our driver community forum', () => Alert.alert('Community', 'Community forum coming soon!'), Colors.secondary)}
